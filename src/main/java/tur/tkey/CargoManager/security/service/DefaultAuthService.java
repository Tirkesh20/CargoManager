...
import tur.tkey.CargoManager.service.EmailSenderService;
...
public class DefaultAuthService implements AuthenticationService{
    ...
    public String register(RegistrationRequest request) {
        //todo->improve logic and ad validation methods
        ...
        String link = "http://localhost:8080/auth/confirm?token=" + token;//todo
        emailSender.send(
                request.getEmail(),
